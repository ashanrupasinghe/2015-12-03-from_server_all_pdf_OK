					...
					<div class="panel-heading" role="tab" id="headingFive">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								...
								aria-controls="collapseFive">Assigned Outreach Officer</a>
						</h4>
					</div>
...
<?php foreach ($outreach_officer_list as $outreach_officer):?>	
			...
			<tr
										...
										<input type="radio" name="assigned-out-officer"
											...
											<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'checked="checked"';endif;?>" disabled>
											<?php */?>
											
											<!-- <input type="radio" name="assigned-out-officer" id="" data-off-color="DEFAULT" value=" --><?php // echo $outreach_officer->fld_username ;?><!-- " data-on-text="Assigne" data-off-text="No" data-size="mini"  --><?php //if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by){ echo 'checked="checked"';}?><!-- > -->
