				...
				<div class="panel panel-default">
					...
					<div id="collapseThree" class="panel-collapse collapse in"
						...
						<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class="form-control" id="attempt_center1"
											...
											<!-- <option value=" -->
											<?php //echo $attempt_center;?>"><?php //echo $attempt_center;?>
											<!-- </option> -->
											<?php //endforeach;?>
										</select>
							...
							<input id="cancel-prog" class="btn btn-warning " type="button"
								value="Cancel edit" onclick="progCancelEdit();">
...
<?php }?>
				...
				<?php //echo 'aaa'.$client['follow_status'][0]->fld_assigned_by.'<br>aaa'.$insert_officer_role_and_center['role_id'].'<br>aaa'.$role_id.'<br>aaa'.$insert_officer_role_and_center['fld_user_center'].'<br>aaa'.$user_center;?>
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingFive">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button" data-toggle="collapse"
								data-parent="#accordion" href="#collapseFive"
								aria-expanded="false" aria-controls="collapseFive">Assign an
								Outreach Officer</a>
...
<?php if ($this->input->post('assigned-out-officer')){echo '<span class="validation-err" aria-hidden="true">please select again</span>';}?>
					...
					<div id="collapseFive" class="panel-collapse collapse in"
						...
						<div class="panel-body">
							...
							<table id="myTablez" class="table responsivetable"
								style="overflow: auto;">
								<thead>
									<tr>
										<th>#</th>
...
<?php foreach ($outreach_officer_list as $outreach_officer):?>
			<tr
										...
										<input type="radio" name="assigned-out-officer"
											value="<?php echo $outreach_officer->fld_username ;?>"<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'checked="checked"';endif;?>>
											<?php */?>
											<input type="radio" name="assigned-out-officer" id="" data-off-color="DEFAULT" value="<?php echo $outreach_officer->fld_username ;?>" data-on-text="Assigne" data-off-text="No" data-size="mini" <?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'checked="checked"';endif;?>>
											</td>
