			...
			<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion"
								...
								aria-controls="collapseOne" class="callrespons-table supermenu">
								Personal Details </a> <span
					...
					<div id="collapseOne" class="panel-collapse collapse in personl-tab"
						...
						<h4 align="center">Personal Details</h4>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="name" id="name" class="form-control"
										value="<?php echo $client['personal'][0]->fld_name;?><?php // echo set_value('name'); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" name="cliendid" id="cliendid"
										class="form-control"
										value="<?php echo $client['personal'][0]->fld_client_id;?><?php // echo set_value('cliendid'); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="id" id="id" class="form-control"
										value="<?php echo $client['personal'][0]->fld_id;?><?php //echo set_value('id'); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="address" class="form-control"
										value="<?php echo $client['personal'][0]->fld_address;?><?php //echo set_value('address'); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea rows="2" cols="" name="map" class="form-control"><?php echo $client['personal'][0]->fld_road_map;?><?php //echo set_value('map'); ?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="availablelink" class="form-control"
										value="<?php echo $client['personal'][0]->fld_if_available_link;?><?php //echo set_value('availablelink'); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="divisional-sec" class="form-control"
										value="<?php echo $client['personal'][0]->fld_divisional_secretariats;?><?php //echo set_value('divisional-sec'); ?>" />
									<?php echo form_error('divisional-sec'); ?>
								</div>
							</div>

							<div class="form-group">
								<label for="text" class="col-sm-3 control-label">Birth Day</label>
								<div class="col-sm-3">
									<input type="date" name="bday" class="form-control datepicker"
										value="<?php echo $client['personal'][0]->fld_birthday;?><?php //echo set_value('bday'); ?>" />
									<?php echo form_error('bday'); ?>
								</div>
								<label for="age" class="col-sm-2 control-label">Age</label>
								<div class="col-sm-3">
									<input name="age" class="form-control" type="text"
										value="<?php echo $client['personal'][0]->fld_age;?><?php //echo set_value('age'); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-4 showhide-container"
									...
									<label for="scl-other">if Other</label> <input type="text"
										...
										value="<?php if ($client['personal'][0]->fld_edu_level=='Other'):echo $client['personal'][0]->fld_edu_level_other; endif;?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<label for="mobile">Mobile</label> <input type="text"
										...
										value="<?php echo $client['personal'][0]->fld_contact_mobile;?>" />
									<?php echo form_error('mobile'); ?>
								</div>
								<div class="col-sm-3">
									<label for="fixed">Fixed</label> <input type="text"
										name="fixed" class="form-control"
										value="<?php echo $client['personal'][0]->fld_contact_fixed;?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" name="children" class="form-control"
										value="<?php echo $client['personal'][0]->fld_no_of_children;?>" />
								...
								<div class="col-sm-2">
									<input type="text" name="childunder18" class="form-control"
										value="<?php echo $client['personal'][0]->fld_children_under_18;?>" />
									...
									<div class="row">
										<div class="col-sm-12">
											<label for="med1">How many times in your life have been
												...
												value="<?php echo $client['personal'][0]->fld_medi_hospitalized_time;?>" />
									...
									<div class="row">
										...
										<div class="col-sm-6 showhide-container" id="med3-container">
											<label for="med3">If Yes</label><input type="text"
												...
												value="<?php if ($client['personal'][0]->fld_medi_chronic_medical=='Yes'): echo $client['personal'][0]->fld_medi_chronic_medical_descript; endif;?>" />
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-3">
									...
									<input name="people-depend-on" class="form-control" type="text"
										value="<?php echo $client['personal'][0]->fld_emp_people_depend_on; ?>">
									...
									<div class="row">
										<div class="col-sm-6">
											<label for="alc_drug1">Nature of Depend</label> <select
												name="alc_drug1" class="form-control">
									...
									<div class="row">
										<div class="col-sm-6">
											<label for="alc_drug3">Age of 1st use</label> <input
												...
												value="<?php echo $client['personal'][0]->fld_alcohol_drug_first_use_age;?>" />
										...
										<div class="col-sm-6">
											<label for="alc_drug4">How many times use per day</label> <input
												...
												value="<?php echo $client['personal'][0]->fld_alcohol_drug_use_per_day;?>" />
							...
							<div class="form-group">
								<label for="my-checkbox" class="col-sm-3 control-label">Accept
									To Follow </label>
								<div class="col-sm-2">
									...
									<input type="checkbox" name="follow-up-accept"
										...
										<?php if ($client['follow_status'][0]->fld_client_accept_reject_followup):echo 'checked';endif;?>>

								</div>
								<!--  -->
								<label for="my-checkbox" class="col-sm-2 control-label">Free
									from Drug</label>
								<div class="col-sm-2">
							...
							<div class="form-group">
							<!--  -->
								<label for="assign-center" class="col-sm-3 control-label">Assign
									Center</label>
								<div class="col-sm-3">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingTwo">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								data-toggle="collapse" data-parent="#accordion"
								href="#collapseTwo" aria-expanded="false"
								aria-controls="collapseTwo"> Details about Custodian </a><span
								class="glyphicon glyph-heading <?php echo $glyphicon;?>"
								aria-hidden="true"></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="cust_name" class="form-control"
										value="<?php echo $client['custodion'][0]->fld_name;?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="cust_address" class="form-control"
										value="<?php echo $client['custodion'][0]->fld_address;?>" />
									...
									<div class="row">
										<div class="col-sm-6">
											<label for="cust_contact_mobile">Mobile</label> <input
												...
												value="<?php echo $client['custodion'][0]->fld_contact_mobile;?>" />
										...
										<div class="col-sm-6">
											<label for="cust_contact_fixed">Fixed</label> <input
												...
												value="<?php echo $client['custodion'][0]->fld_contact_fixed;?>" />
									...
									<div class="row">
										...
										<div class="col-sm-6 showhide-container"
											...
											<label for="other-relationship">If Other</label> <input
												...
												value="<?php if ($client['custodion'][0]->fld_relationship=='Other'): echo $client['custodion'][0]->fld_relationship_other; endif;?>" />
					...
					<div class="panel-heading" role="tab" id="headingThree">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								...
								aria-controls="collapseThree"> Progress of Treatment </a><span
								class="glyphicon glyph-heading <?php echo $glyphicon;?>"
								aria-hidden="true"></span>
						</h4>
					</div>
					...
					<div class="panel-heading" role="tab" id="headingFour">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								...
								aria-controls="collapseFour"> Feedback about Follow Ups </a><span
								class="glyphicon glyph-heading <?php echo $glyphicon;?>"
								aria-hidden="true"></span>
						</h4>
					</div>
					<div id="collapseFour" class="panel-collapse collapse in"
						...
						<div class="panel-body">
							...
							<div class="fllowuptableone" style="overflow: auto">
								...
								<?php  if (count($client['feedback'] )<1):?>
							<div class="panel-body">
										<!-- forms content -->
										<div class="form-group">
											<label for="no-result-feedback"
												class="col-sm-3 control-label">No Result to Display</label>
										</div>
									</div>
...
<?php }?>
					...
					<!--  -->
								...
								<?php if (!empty($outreach_officer_list) && $client['follow_status'][0]->fld_assigned_by!=NULL && $insert_officer_role_and_center['role_id']==$role_id && $insert_officer_role_and_center['fld_user_center']==$user_center):?>
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingFive">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								...
								aria-controls="collapseFive">Assign an Outreach Officer</a>
<?php if (form_error('assigned-out-officer')){echo '<span class="glyphicon glyphicon-thumbs-down validation-err" aria-hidden="true"></span>';}?>
<?php if ($this->input->post('assigned-out-officer')){echo '<span class="validation-err" aria-hidden="true">please select again</span>';}?>
						</h4>
					</div>
...
<?php
									...
									?>
<?php foreach ($outreach_officer_list as $outreach_officer):?>
			<tr
										class="<?php if ($count%2==0){echo 'tbl-color-odd';}else{echo 'tbl-color-even';}?>"
										<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'style="background-color: rgb(233, 233, 255) !important;"';endif;?>>
										<td><?php echo $count;?></td>

										<td><?php echo $outreach_officer->user_id ;?></td>
										<td><?php echo $outreach_officer->fld_username ;?></td>

										<td><?php echo $outreach_officer->fld_firstname ; ?></td>
										<td><?php echo $outreach_officer->fld_lastname ; ?></td>
										<td><?php echo $outreach_officer->fld_location ; ?></td>
										<td><?php echo $outreach_officer->fld_contactno ; ?></td>
										<td>
										<?php
/*
										       * ?>
										       * <input type="radio" name="assigned-out-officer"
										       * value="<?php echo $outreach_officer->fld_username ;?>"<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by){ echo 'checked="checked"';}?>"
										       * >
										       * <?php
										       */
										?>
										<input type="radio" name="assigned-out-officer" id=""
											data-off-color="DEFAULT"
											value="<?php echo $outreach_officer->fld_username ;?>"
											data-on-text="Assigne" data-off-text="No" data-size="mini"
											<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'checked="checked"';endif;?>>
...
$("[name='assigned-out-officer']").bootstrapSwitch();
$('#myTabley').DataTable( {
    responsive: true,
    "autoWidth": false
} );
