					...
					<div class="col-lg-6">
						...
						?>
							...
							<div class="form-group">
								...
								<input type="text" name="nic_no" class="form-control" value="<?php echo set_value('nic_no');?>">
						...
						?>
								...
								<label for="is_active">Is Active?</label>
									...
									<div class="input-group input-group-lg">
										<label class="radio-inline">
											<input type="radio" name="is_active" value="1" <?php if(preg_match('/Update/', $title)&&$user[0]->is_active==1){echo "checked";}?><?php if (preg_match('/View/', $title)){ if($user[0]->is_active==1){echo 'checked';}else {echo 'disabled';}} ?>>Active
										</label>
										<label class="radio-inline">
											<input type="radio" name="is_active" value="0" <?php if(preg_match('/Update/', $title)&&$user[0]->is_active==0){echo "checked";}?><?php if (preg_match('/View/', $title)){ if($user[0]->is_active==0){echo 'checked';}else {echo 'disabled';}} ?>>Inactive
										</label>
									</div>
							</div>
							...
							<div class="form-group">
								...
								<select class="form-control" name="assigned_to" value="<?php echo set_value('assigned_to');?>"<?php if (preg_match('/View/', $title)){ echo 'disabled';} ?>>
									<option value="">--Please Select--</option>
									<?php  foreach ($assigned_to as $row):?>
									<option value="<?php  echo $row->fld_username;?>" <?php if($user[0]->fld_assigned_to==$row->fld_username ){echo "selected";}else { echo set_select('assigned_to', $row->fld_username);} ?>><?php  echo $row->fld_username;?></option>
									<?php endforeach;?>
								</select>
								<div class="error_msg"><?php echo form_error('assigned_to'); ?></div>
							</div>
