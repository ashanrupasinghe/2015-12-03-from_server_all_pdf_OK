									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<select name="med2" id="med2" class="form-control">
												<option value="No"
													<?php if ($selected_med2=="No"){echo "selected";}?>>No</option>
												<option value="Yes"
...
<?php $selected_employement = ($this->input->post('employment')) ? $this->input->post('employment') : $employments[0][0];?>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="cust_name" class="form-control"
										value="<?php echo $this->input->post("cust_name");?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="cust_address" class="form-control"
										value="<?php echo $this->input->post("cust_address");?>" />
									...
									<div class="row">
										<div class="col-sm-6">
											<label for="cust_contact_mobile">Mobile</label> <input
												...
												value="<?php echo $this->input->post("cust_contact_mobile");?>" />
										...
										<div class="col-sm-6">
											<label for="cust_contact_fixed">Fixed</label> <input
												...
												value="<?php echo $this->input->post("cust_contact_fixed");?>" />
									...
									<?php endforeach;?>	
										...
										<div class="col-sm-6 showhide-container"
											...
											<label for="other-relationship">If Other</label> <input
												...
												value="<?php echo $this->input->post("other-relationship");?>" />
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingFour">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button" data-toggle="collapse"
								...
								aria-expanded="false" aria-controls="collapseFour">Assign an
								Outreach Officer</a>
					...
					<div id="collapseFour" class="panel-collapse collapse in"
						...
						$selected_officer = ($this->input->post ( 'assigned-out-officer' )) ? $this->input->post ( 'assigned-out-officer' ) : '';
						echo $selected_officer;
						?>
						<?php if (!empty($outreach_officer_list)):?>					
						<table id="myTablex" class="table responsivetable">
								<thead>
									<tr>
										<th>#</th>
										<th>user_id</th>
...
<?php foreach ($outreach_officer_list as $outreach_officer):?>			
			<tr
										class="<?php if ($count%2==0){echo 'tbl-color-odd';}else{echo 'tbl-color-even';}?><?php if ($outreach_officer->fld_username==$this->input->post('assigned-out-officer')){echo ' selected-outreach';} ?>">
										...
										<input type="radio" name="assigned-out-officer"
											...
											<?php if ($selected_officer==$outreach_officer->fld_username){echo "checked";}?>>
											<?php */?>
											<input type="radio" name="assigned-out-officer" id="" data-off-color="DEFAULT" value="<?php echo $outreach_officer->fld_username ;?>" data-on-text="Assigne" data-off-text="No" data-size="mini" <?php if ($outreach_officer->fld_username==$this->input->post('assigned-out-officer')){echo 'checked="checked"';}?>
											</td>
...
<?php echo form_error('assigned-out-officer'); ?>								
<?php endif;?>
