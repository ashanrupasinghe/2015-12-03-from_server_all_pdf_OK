					...
					<div id="collapseOne" class="panel-collapse collapse in personl-tab"
						...
						<h4 align="center">Personal Details</h4>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea rows="2" cols="" name="map" class="form-control"
										disabled><?php echo $client['personal'][0]->fld_road_map;?><?php //echo set_value('map'); ?></textarea>
					...
					<div class="panel-heading" role="tab" id="headingFive">
						<h4 class="panel-title">
							<a class="callrespons-table supermenu" role="button"
								...
								aria-controls="collapseFive">Assignd Outreach Officer</a>
						</h4>
					</div>
...
<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by):?>	
			<tr
										...
										id="<?php echo $outreach_officer->fld_username;?>">
...
/*
						       ...
						       * value="<?php echo $outreach_officer->fld_username ;?>"<?php if ($outreach_officer->fld_username==$client['follow_status'][0]->fld_assigned_by): echo 'checked="checked"';endif;?>" disabled>
						       * <?php
						       */
						?>	
